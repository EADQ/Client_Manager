...
#CREANDO CONEXION Y NOMBRE DE NUESTRA BASE DE DATOS
conn = sqlite3.connect('crm.db')

#CREANDO EL CURSOR DONDE VAMOS A REALIZAR NUESTRAS CONSULTAS A LA BASE DE DATOS
c = conn.cursor()

#CREANDO LA TABLA DONDE VAMOS A GENERAR TODOS LOS REGISTROS
c.execute("""
...
#CREANDO LAS FUNCIONES DE LA APLICACION
...
def eliminar_cliente():
    ...
    respuesta = messagebox.askokcancel('Confirmación?' ' Estas seguro de querer eliminar el cliente?' + cliente[1] + '?')
    if respuesta:
...
#AGREGANDO LA TABLA DONDE VAMOS A IR AGREGANDO A NUESTROS CLIENTES
